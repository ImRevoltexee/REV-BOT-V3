...
let arrayMenu = ['all', 'anime', 'update', 'maker', 'edukasi', 'news', 'random', 'game', 'xp', 'Kristen', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database','Alkitab', 'vote', 'nsfw', 'audio', 'jadibot', 'info', 'owner', 'store', 'virus', 'thnks']
...
{title: `🗒️ ›〚 All Menu 〛`, rowId: ".? all", description: "╰► Waduhh. Langsung semuanya (≧▽≦)"},
	...
	{title: `⛪ ›〚 Kristen 〛`, rowId: ".? Alkitab", description: "╰► Fitur Ini Masih Dalam Pengembangan..."},
	...
	{title: `🧰️ ›〚 Tools 〛`, rowId: ".? tools", description: "╰► Butuh apa aja bot akan bantu "},
