...
esteh: 0,
    ...
    return new Promise(async(resolve, reject) => {
        ...
        resolve(ab)
          ...
          global.kontak2 = [
        ['6283164445159', 'Rev-Bot', 'Creator Bot', 'Creator Bot', true],
...
Fitur ini di *disable* !`
    ...
    if (msg) return conn.sendButton(m.chat, danied, msg, `${imgr + 'Accses Danied'}`, [['MENU', '.menu'],['OWNER', '.menu']],m)
     ...
     let msgg = {
    	unreg: `${nmsr}\nSilahkan REGISTER ke database terlebih dahulu untuk menggunakan bot ini lebih lanjut *Click button di bawah*\n\n*Kalian bisa ikuti langkah² REGISTRASI selanjutnya*`
}[type]
if (msgg) return conn.sendButton(m.chat, `${global.htki} REGISTER ${global.htka}`, msgg, `${imgr + 'Verify'}`, [['REGISTER', '/verify']],m)
}
